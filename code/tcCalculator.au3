...
$idGroup_FPS = GUICtrlCreateGroup(GetStringFromResources($anArayStringsSettingsTabGeneral[$eGroupFPS]), 20, 50, 340, 80)                                                        ;"Frames per second"
GUICtrlSetFont(-1, 10, 400, 0, "Segoe UI")
$idLabel_FPS = GUICtrlCreateLabel(GetStringFromResources($anArayStringsSettingsTabGeneral[$eLabelFPS]), 40, 84, 205, 21, $SS_RIGHT)                                             ;"FPS:"
